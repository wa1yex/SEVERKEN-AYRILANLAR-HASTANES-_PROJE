...
namespace Proje_Hastane
{
    public partial class FrmSekreterDetay : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("Update Tbl_Randevular set RandevuTarih=@p1,RandevuSaat=@p2,RandevuBrans=@p3,RandevuDoktor=@p4 where Randevuid=@p5", bgl.baglanti());
